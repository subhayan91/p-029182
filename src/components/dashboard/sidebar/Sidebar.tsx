    ...
    import { UserButton, SignedIn, SignedOut, OrganizationSwitcher } from "@clerk/clerk-react";

    export const Sidebar: React.FC = () => {
      const navigate = useNavigate();

      return (
        <div className="bg-white min-w-60 min-h-screen w-[250px] border-[rgba(234,236,240,1)] border-r flex flex-col">
          ...
          <SignedIn>
            <div className="p-4 border-b border-[rgba(234,236,240,1)]">
              <OrganizationSwitcher
                afterCreateOrganizationUrl="/create-organization"
                afterLeaveOrganizationUrl="/login"
                appearance={{
                  elements: {
                    organizationSwitcherTrigger: "w-full justify-between text-[#253A82] font-medium",
                    organizationPreviewTextContainer: "text-sm",
                    organizationSwitcherPopoverCard: "mt-2",
          ...
          <div className="p-4 mt-auto border-t border-[rgba(234,236,240,1)]">
            <SignedIn>
              <div className="flex items-center space-x-2">
                 ...
                 <div className="text-sm text-[#253A82] font-medium">My Account</div>
              </div>
            </SignedIn>
            <SignedOut>
